...
### Améliorer le Q-Learning
1. **Deep Q-Learning (DQN)** : Remplacer la table Q par un réseau de neurones
2. **Double Q-Learning** : Éviter la surestimation des valeurs Q
3. **Decay ε** : Réduire l'exploration au fil du temps
4. **Replay Buffer** : Apprendre sur les parties passées

### Autres jeux
Appliquer Q-Learning à :
- **Connect Four** (Puissance 4)
- **Chess** (avec approximation)
- **Pac-Man**
- **CartPole** (équilibre d'un pendule)

---

## ‍ Auteur

Projet développé pour un cours d'Intelligence Artificielle.

**Concepts** : Minimax, Alpha-Beta, Q-Learning, Reinforcement Learning

**Langage** : 100% Python, 100% Français
